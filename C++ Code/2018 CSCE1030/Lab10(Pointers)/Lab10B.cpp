/*  Author:  Haskell Cappers (haskellcappers@my.unt.edu)
    ...
    Description: Assigning a pointer to a interger memory location, changing the value, and setting a second point to the location then deleting both pointers.
*/
#include <iostream>
using namespace std;
